...
sidebar_position: 8
description: 'Chapter I: As a Prisoner, I Hope to See You'
---

import AudioPlayer from '@site/src/components/common/AudioPlayer'

# Letter to the Romans

<AudioPlayer
  audioURL='/audio/saints/saint-ignatius/saint-ignatius-letter-to-romans-audio.mp4'
  audioFileDownloadName='St. Ignatius - Letter to the Romans.mp4'
/>
...
- [Letter to the Romans](http://persweb.wabash.edu/facstaff/royaltyr/AncientCities/web/bradleyj/Project%201/The%20Epistle%20of%20Ignatius%20to%20the%20Romans.html)
